                    ...
                    <div class="box-body">
                        ...
                        <nav aria-label="breadcrumb">
                          ...
                          <li class="breadcrumb-item"><a href="index.php">Ebeveyn Dasboard</a></li>
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sisteme Anı Kaydet</li>
                          </ol>
                        </nav>

                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active">
                    <form method="POST" enctype="multipart/form-data" action="aniekleislem.php">
                      <div style="margin-top:10px">
                        <div class="col-xs-2">
                          <label>Kayıt Kodu</label>
                          <input type="text" class="form-control" name="kimlik" disabled="" autocomplete="off" 
                            required>
                        </div>
                        
                        <div class="col-xs-10">
                          <label>Çocuk Adı</label>
                          <input type="text" class="form-control" name="cocukadi"  autocomplete="off" value="<?php echo $adsoyad ?>"
                            required>
                        </div>
                      </div>
                        </div>
                      <div class="col-xs-6">
                          ...
                          <input type="date" class="form-control" name="olaytarihi" autocomplete="off" 
                            required>
                        </div>
                        
                        <div class="col-xs-6">
                          <label>Anı Resmi</label>
                          <input type="file" class="form-control" name="olayresim"  autocomplete="off"
                            required>
                        </div>
                      </div>
                  </div>
                  <div class="col-xs-12">
                          ...
                          <input type="text" class="form-control" name="olaybasligi"  autocomplete="off"
                            required>
                        </div>
                  <div class="col-xs-12">
                  <label style="margin-top:10px">Açıklama</label>
                  <textarea class="form-control" name="olayaciklamasi"></textarea>
                  </div>
                  <hr><br></br>
