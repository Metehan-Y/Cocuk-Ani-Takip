            ...
            <div class="col-md-12">
                ...
                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active">
                    <form method="POST" enctype="multipart/form-data" action="ekle.php">
                      <div style="margin-top:10px">
                        ...
                        <div class="col-xs-6">
                          ...
                          <input type="text" class="form-control" name="adsoyad" autocomplete="off"
                            required>
                        </div>
                        <div class="col-xs-4">
                      ...
                      <div class="col-xs-6">
                          ...
                          <input type="date" class="form-control" name="dtarihi" autocomplete="off"
                            required>
                        </div>
                        <div class="col-xs-6">
                          <label>Resim</label>
                          <input type="file" class="form-control" name="resim" autocomplete="off"
                            required>
                        </div>
                      </div>
                  </div>
