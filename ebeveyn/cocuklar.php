            ...
            <div class="col-md-12">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Çocuklarım</li>
                  </ol>
                </nav>
                <div class="d-flex justify-content-end">
                  <a href="cocukekle.php"><button class="btn btn-info"><i class="fa fa-plus-square"></i> Yeni
                      Ekle</button></a><hr>
                </div>
                <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                  ...
                  <tbody>
                    <?php
                      ...
                      $sql1="SELECT * FROM cocuklar where ebeveynid=".$islem['id']; 
		                    /////////////////////////////
                        ...
                        foreach ($baglan->query($sql1) as $row)
                        {
                          ...
                          <td>".$dtarihi."</td>
                          <td>".$cinsiyet."</td>
                          <td><a target='_blank' class='btn btn-warning' href='../portfolyo/index.php?id=".$id."&cocukadi=".$adsoyad."&ebeveynadi=".$islem['adsoyad']."'>Portfolyoyu Aç</a></td>
                          <td><a class='btn btn-info' href='aniekle.php?id=".$id."'>Anı Ekle</a></td>
                          <td><a class='btn btn-primary' href='fotografekle.php?id=".$id."'>Fotograf Ekle</a></td>
                          <td style='width:10%'>
                        <a href='cocukguncelle.php?id=".$id."' class='btn btn-primary' title='Düzenle'><i class='fa fa-pencil'></i></a>
                        <a href='sil.php?id=".$id."' class='btn btn-danger' title='Sil!'><i class='fa fa-trash-o'></i></a>
                      </td>
                        </tr>";
                        }
                    ?>
