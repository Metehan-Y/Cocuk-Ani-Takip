            ...
            <div class="col-md-12">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Anılar</li>
                  </ol>
                </nav>
                ...
                <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                  ...
                  <tbody>
                    <?php
                      ...
                      $sorgu=$baglan->prepare("SELECT * FROM cocuklar WHERE ebeveynid=?");
                      $sorgu->execute(array($islem['id']));
                      $islemiki=$sorgu->fetch();


                      $sql1="SELECT * FROM olaylar where cocukadi='".$islemiki['adsoyad']."'"; 
		                    /////////////////////////////
                        ...
                        foreach ($baglan->query($sql1) as $row)
                        {
                          ...
                          <td>".$olaybasligi."</td>
                          <td>
                        <a href='aniguncelle.php?id=".$id."' class='btn btn-primary' title='Düzenle'><i class='fa fa-pencil'></i></a>
                        <a href='anisil.php?id=".$id."' class='btn btn-danger' title='Sil!'><i class='fa fa-trash-o'></i></a>
                      </td>
                        </tr>";
                        }
                    ?>
