                ...
                <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                  ...
                  <tbody>
                    ...
                    $islemiki=$sorgu->fetch();
                      ...
                      $sql1="SELECT * FROM galeri where cocukid='".$islemiki['id']."'"; 
		                    /////////////////////////////
                        ...
                        foreach ($baglan->query($sql1) as $row)
                        {
                          ...
                          $tarih = $row['tarih']; 
                          echo "<tr>
                          <td><img style='width: 50px; height: 50px; object-fit: cover;' src='img/".$resim."'></img></td>
                          <td>".$cocukadi."</td>
                          <td>".$tarih."</td>
                          <td>
                        
                        <a href='galerisil.php?id=".$id."' class='btn btn-danger' title='Sil!'><i class='fa fa-trash-o'></i></a>
                      </td>
                        </tr>";
                        }
                    ?>
