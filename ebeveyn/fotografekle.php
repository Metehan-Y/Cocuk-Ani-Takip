...
<br><br>
    ...
    <li class=""><a href="cocuklar.php"><i class="fa fa-child"></i> <span>Çocuklar</span></a></li>
		...
		<li class="active"><a href="fotograf.php"><i class="fa fa-image"></i> <span>Fotograflar</span></a></li>
		      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
                    ...
                    <div class="box-body">
                        ...
                        <nav aria-label="breadcrumb">
                          ...
                          <li class="breadcrumb-item"><a href="index.php">Ebeveyn Dasboard</a></li>
                            <li class="breadcrumb-item"><a href="fotograf.php">Fotograf Galerisi</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Fotograf Ekle</li>
                          </ol>
                        </nav>

                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active">
                    <form method="POST" enctype="multipart/form-data" action="fotografekleislem.php">
                      <div style="margin-top:10px">
                      <div class="col-xs-2">
                          <label>Çocuk Kayıt Kodu</label>
                          <input type="text" class="form-control" name="cocukid" autocomplete="off" value="<?php echo $id ?>"
                            required>
                        </div>
                        <div class="col-xs-10">
                  ...
                  &emsp; <button class="btn btn-primary">Kaydet</button>
                  </div><br></br>
                  </form>
                </div>
