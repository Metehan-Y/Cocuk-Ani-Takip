...
<br><br>
    ...
    <li class="active"><a href="cocuklar.php"><i class="fa fa-child"></i> <span>Çocuklar</span></a></li>
                    ...
                    <div class="box-body">
                        ...
                        <nav aria-label="breadcrumb">
                          ...
                          <li class="breadcrumb-item"><a href="index.php">Ebeveyn Dasboard</a></li>
                            <li class="breadcrumb-item"><a href="cocuklar.php">Çocuklarım</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Sisteme Çocuk Kaydet</li>
                          </ol>
                        </nav>

                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active">
                    <form method="POST" enctype="multipart/form-data" action="guncelle.php?id=<?php echo $id ?>">
                      <div style="margin-top:10px">
                        <div class="col-xs-2">
                          <label>Kayıt Kodu</label>
                          <input type="text" class="form-control" name="kimlik" disabled="" autocomplete="off" value="<?php echo $id ?>"
                            required>
                        </div>
                        <div class="col-xs-6">
                          <label>Adı Soyadı</label>
                          <input type="text" class="form-control" name="adsoyad" autocomplete="off" value="<?php echo $adsoyad ?>"
                            required>
                        </div>
                        <div class="col-xs-4">
                          <label>Cinsiyeti</label>
                          <select class="custom-select form-control" id="validationCustom04" name="cinsiyet" required>
                            <option selected disabled value="">Lütfen Cinsiyet Seçiniz</option>
                            <option <?php if($cinsiyet =="Erkek"){ echo "selected";} ?> value="Erkek">Erkek</option>
                            <option <?php if($cinsiyet =="Kadın"){ echo "selected";} ?> value="Kadın">Kadın</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-xs-6">
                          ...
                          <input type="date" class="form-control" name="dtarihi" autocomplete="off" value="<?php echo $dtarihi ?>"
                            required>
                        </div>
                        <div class="col-xs-6">
                          <label>Resim</label>
                          <input type="file" class="form-control" name="resim" autocomplete="off" disabled>
                        </div>
                      </div>
                  </div>
                  <div class="col-12">
                  <label style="margin-top:10px">Biografi</label>
